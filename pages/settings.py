...
# API Keys are now securely fetched from environment variables
st.session_state['TWITTER_BEARER_TOKEN'] = st.text_input("Twitter Bearer Token", value=os.getenv("TWITTER_BEARER_TOKEN"), type="password")
st.session_state['YOUR_OPENAI_API_KEY'] = st.text_input("OpenAI API Key", value=os.getenv("YOUR_OPENAI_API_KEY"), type="password")
st.session_state['HEYGEN_API_KEY'] = st.text_input("Heygen API Key", value=os.getenv("HEYGEN_API_KEY"), type="password")
st.session_state['D_ID_API_KEY'] = st.text_input("D-ID API Key", value=os.getenv("D_ID_API_KEY"), type="password")
st.session_state['YOUTUBE_API_KEY'] = st.text_input("YouTube API Key", value=os.getenv("YOUTUBE_API_KEY"), type="password")
